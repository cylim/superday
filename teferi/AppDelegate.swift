...
class AppDelegate : UIResponder, UIApplicationDelegate
{
    ...
    private let timeSlotCreationService = DefaultTimeSlotCreationService(persistencyService: CoreDataPersistencyService.instance)
    ...
    lazy var managedObjectModel: NSManagedObjectModel =
    {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("teferi", withExtension: "momd")!
